...
# TBD
position = {
    "up_position": 1.5704847574234009,
    "down_position": -2.823723077774048,
    "up_limit": 6.563328742980957,
    "down_limit": -4.600384712219238,
    "v_max": 5,
    "t_min": 0.5,
    "t_max": 1.5,
}
...
class Controller:
    ...
    def lim_check(self, i):
        if (
            self.joint_position < position["up_limit"]
            or self.joint_position > position["down_limit"]
            or i == 199
        ):
            return True
    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            if i:  # go up
                ...
                path = cmd.logistic_fct(
                    t, t_des / 1.5, t_des + np.sign(t_meas) * 0.1, 0.75
                )
